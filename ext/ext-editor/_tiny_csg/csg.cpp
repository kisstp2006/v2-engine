...
void brush_t::set_planes(const vector_t<plane_t>& planes) {
    this->planes = planes;
...
const vector_t<plane_t>& brush_t::get_planes() const {
    return planes;
}
...
const vector_t<face_t>& brush_t::get_faces() const {
    return faces;
}
